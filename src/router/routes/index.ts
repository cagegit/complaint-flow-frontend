...
import { mobileH5RoutesList } from './mobileRouter';
...
export const basicRoutes = [LoginRoute, RootRoute, ...mobileH5RoutesList, ...mainOutRoutes, REDIRECT_ROUTE, PAGE_NOT_FOUND_ROUTE, TokenLoginRoute, Oauth2LoginRoute];
