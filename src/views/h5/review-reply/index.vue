        ...
        <div style="flex: 1">
          ...
          <a-tabs v-model:activeKey="activeKey">
            <a-tab-pane key="1" tab="回复审核">
              <!-- 回复列表 -->
              <div class="pr-4">
                <ReplyRecord :replyData="replyList" :total="total" :readOnly="false" @auditChange="handleAuditChange" />
              </div>
              <!-- 分割线 -->
...
<script lang="ts" setup>
  import { ref, onMounted, unref, useAttrs } from 'vue';
  import { BasicForm, useForm } from '/@/components/Form/index';
  import { formSchema, formAuditSchema } from '/@/views/complain/review-reply/review.data';
  import { useRoute } from 'vue-router';
  import { saveReviewReply, getReplyDetail } from '/@/views/complain/review-reply/review.api';
