<template>
  ...
  <BasicTable @register="registerTable" :rowSelection="rowSelection">
    ...
    <template #tableTitle>
      ...
      <a-button type="primary" v-auth="'complain:manager:exportTicketWord'" preIcon="ant-design:export-outlined" @click="onExportTicketWords">
        导出word工单</a-button
      >
      <a-button type="primary" v-auth="'complain:manager:exportKickOut'" preIcon="ant-design:export-outlined" @click="onExportKickOut">
        导出剔除工单</a-button
      >
      <a-button type="primary" v-auth="'complain:manager:exportExcelStatis'" preIcon="ant-design:export-outlined" @click="onExportExcelStatis"
        >导出Excel统计表</a-button
      >
      <a-button type="primary" v-auth="'complain:manager:exportDayExport'" preIcon="ant-design:export-outlined" @click="onExportDayExcel"
        >导出日报表</a-button
      >
      <a-dropdown>
        <template #overlay>
