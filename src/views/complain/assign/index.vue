<template>
  ...
  <BasicTable @register="registerTable" :rowSelection="rowSelection">
    <!--插槽:table标题-->
    <template #tableTitle>
      <a-button type="primary" preIcon="ant-design:export-outlined" @click="onExportTicketWords" v-auth="'complain:assign:exportTicketWord'"
        >导出word工单</a-button
      >
  ...
  <BasicModal
    ...
    destroyOnClose
  >
    <BasicForm @register="registerSuggestForm" ref="suggestFormRef" />
  </BasicModal>
</template>
<script lang="ts" setup name="forward-complain">
  ...
  onMounted(() => {
    // 获取退回类型字典
    getDistrictDictByCode('back_type')
      .then((res) => {
        console.log('res', res);
