...
<script lang="ts">
  ...
  import UploadModal from './UploadItemModal.vue';
  import UploadPreviewModal from './UploadItemPreviewModal.vue';
  import { Icon } from '/@/components/Icon';
  import { Tooltip } from 'ant-design-vue';
  import { useModal } from '/@/components/Modal';
  import { uploadContainerProps, UploadFileItem } from './props';
  import { omit } from 'lodash-es';
  import { useI18n } from '/@/hooks/web/useI18n';
  import { isArray } from '/@/utils/is';

  export default defineComponent({
    name: 'BasicUploadItem',
    ...
    setup(props, { emit, attrs }) {
      ...
      // 上传modal保存操作
      function handleChange(items: UploadFileItem[]) {
      ...
      // 预览modal保存操作
      function handlePreviewChange(items: UploadFileItem[]) {
      ...
      function handlePreviewDelete(item: UploadFileItem) {
        emit('preview-delete', item);
      }
